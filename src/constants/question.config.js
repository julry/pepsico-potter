...
export const questions = [
    ...
    },
    {
        ...
        answers: [
            ...
            {
                id: 3,
                text: 'Хочу научиться филигранно подбирать инструменты исследований и аналитики, ' +
                    'чтобы помогать бизнесу принимать ключевые решения по продажам и продвижению',
                points: [answerTypes.Analytics]
            },
        ]
    },
